    ...
    return (
        ...
        <nav className="sidebar">
             ...
             <ul>
               ...
               <li ><Link className="Link-align" to="/ImgxBase64"><img src={ImgxBase64} alt="" />PDF x Img</Link></li>
               <li ><Link className="Link-align" to="/contact"><img src={Base64xImg} alt="" />Contato</Link></li> 
             </ul>
           </nav>
